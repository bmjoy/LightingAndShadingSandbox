...
Shader "Pipeworks_Custom/Lambert Wrap"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif
			float3 newWorldNormal22_g32 = WorldNormalVector( i , float3(0,0,1) );
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldlightDir = normalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			float dotResult3_g34 = dot( newWorldNormal22_g32 , ase_worldlightDir );
			float temp_output_6_0_g33 = (saturate( max( dotResult3_g34 , 0.0 ) )*0.65 + ( 1.0 - 0.65 ));
			float3 normalizeResult24_g32 = normalize( newWorldNormal22_g32 );
			UnityGI gi37_g32 = gi;
			gi37_g32 = UnityGI_Base( data, 1, normalizeResult24_g32 );
			float3 indirectDiffuse37_g32 = gi37_g32.indirect.diffuse;
			float2 uv_BaseRGB = i.uv_texcoord * _BaseRGB_ST.xy + _BaseRGB_ST.zw;
			float4 temp_output_28_0_g32 = tex2D( _BaseRGB, uv_BaseRGB );
			c.rgb = saturate( ( ( ( saturate( max( ( temp_output_6_0_g33 * temp_output_6_0_g33 ) , 0.0 ) ) * ( _LightColor0.rgb * ase_lightAtten ) ) + indirectDiffuse37_g32 ) * (_BaseTint).rgb * (temp_output_28_0_g32).rgb ) );
			c.a = 1;
			return c;
		}
...
Node;AmplifyShaderEditor.FunctionNode;24;-425.1688,45.30499;Float;False;Lambert Wrap;-1;;32;31f8f5f80290a284a82e58e8d6bb3fef;5;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT3;0,0,0;False;2;FLOAT3;FLOAT
Node;AmplifyShaderEditor.SaturateNode;25;-81.02295,44.77969;Float;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3
...
ASEEND*/
//CHKSM=FB438D019EE82EB6E71333FA4C528770C3BAD308