...
Shader "Pipeworks_Custom/Terrain Scatter ASE"
{
	Properties
	{
		...
		[Toggle]_ScatterEnable("Scatter Enable", Float) = 0
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			o.vertexToFrag541 = ( appendResult434 * ( ( v3InverseWavelength442 * fKrESun ) + fKmESun ) );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif
			float4 temp_output_43_0_g182 = _SpecularColor;
			float3 ase_worldPos = i.worldPos;
			half3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 ase_worldlightDir = normalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			float3 normalizeResult4_g183 = normalize( ( ase_worldViewDir + ase_worldlightDir ) );
			float2 uv_NormalMap63 = i.uv_texcoord;
			half3 NORMALS65 = UnpackScaleNormal( tex2D( _NormalMap, uv_NormalMap63 ) ,_NormalScale );
			float3 normalizeResult64_g182 = normalize( WorldNormalVector( i , NORMALS65 ) );
			float dotResult19_g182 = dot( normalizeResult4_g183 , normalizeResult64_g182 );
			float3 temp_output_40_0_g182 = ( _LightColor0.rgb * ase_lightAtten );
			float2 uv_SpecMap = i.uv_texcoord * _SpecMap_ST.xy + _SpecMap_ST.zw;
			float3 SPEC131_g182 = ( (temp_output_43_0_g182).rgb * (temp_output_43_0_g182).a * pow( max( dotResult19_g182 , 0 ) , ( _Gloss * 128 ) ) * temp_output_40_0_g182 * (tex2D( _SpecMap, uv_SpecMap )).rgb );
			float dotResult14_g182 = dot( normalizeResult64_g182 , ase_worldlightDir );
			float temp_output_15_0_g182 = max( dotResult14_g182 , 0 );
			UnityGI gi34_g182 = gi;
			float3 diffNorm34_g182 = normalizeResult64_g182;
			gi34_g182 = UnityGI_Base( data, 1, diffNorm34_g182 );
			float3 indirectDiffuse34_g182 = gi34_g182.indirect.diffuse + diffNorm34_g182 * 0.0001;
			...
			float4 temp_output_42_0_g182 = half4( DIFFUSE459 , 0.0 );
			...
			float3 scatterDiffuse120_g182 = ( ( (temp_output_42_0_g182).rgb * scatterAtten497 ) + scatterColor498 );
			...
			float smoothstepResult111_g182 = smoothstep( 0 , _NightLightsSoftness , temp_output_15_0_g182);
			fixed NL_ALPHA85_g182 = ( 1.0 - saturate( smoothstepResult111_g182 ) );
			float temp_output_84_0_g182 = min( NIGHTLIGHTS462 , NL_ALPHA85_g182 );
			half NL_R80_g182 = ( _NightLightRed * temp_output_84_0_g182 );
			half NL_G81_g182 = ( _NightLightGreen * temp_output_84_0_g182 );
			half NL_B82_g182 = ( temp_output_84_0_g182 * _NightLightBlue );
			float3 appendResult99_g182 = (half3(( lerp(( SPEC131_g182 + ( ( ( temp_output_40_0_g182 * temp_output_15_0_g182 ) + indirectDiffuse34_g182 ) * (temp_output_42_0_g182).rgb ) ),( SPEC131_g182 + scatterDiffuse120_g182 ),_ScatterEnable).x + NL_R80_g182 ) , ( lerp(( SPEC131_g182 + ( ( ( temp_output_40_0_g182 * temp_output_15_0_g182 ) + indirectDiffuse34_g182 ) * (temp_output_42_0_g182).rgb ) ),( SPEC131_g182 + scatterDiffuse120_g182 ),_ScatterEnable).y + NL_G81_g182 ) , ( lerp(( SPEC131_g182 + ( ( ( temp_output_40_0_g182 * temp_output_15_0_g182 ) + indirectDiffuse34_g182 ) * (temp_output_42_0_g182).rgb ) ),( SPEC131_g182 + scatterDiffuse120_g182 ),_ScatterEnable).z + NL_B82_g182 )));
			c.rgb = appendResult99_g182;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=14404
1957;50;1819;1125;4207.708;1046.412;3.80283;True;True
Node;AmplifyShaderEditor.CommentaryNode;464;-2777.543,206.8116;Float;False;3386.324;2401.76;;103;404;411;403;409;305;410;408;407;406;405;400;398;319;542;541;543;540;447;436;434;445;302;444;431;301;443;417;307;442;390;441;423;486;426;418;392;422;485;304;303;425;389;391;296;310;387;354;388;367;393;377;363;353;394;382;376;365;381;352;350;306;364;351;380;375;372;299;378;427;528;373;297;362;527;357;294;358;526;525;346;343;396;384;340;523;522;298;317;313;330;325;521;324;321;315;520;320;314;311;293;538;537;533;Ground Atmospheric Scattering;0.05862069,0.5,0,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;306;-484.5512,845.4196;Float;False;Global;fScaleHeight;fScaleHeight;16;1;[HideInInspector];Create;True;0;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;393;-392.1411,828.2336;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;394;-376.1412,829.2336;Float;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;296;-2530.732,2101.577;Float;False;Global;v3InvWavelength;v3InvWavelength;16;1;[HideInInspector];Create;True;0;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;486;-2327.781,2444.113;Float;False;407;0;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;485;-2331.269,2375.49;Float;False;404;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;441;-2341.445,2307.04;Float;False;411;0;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;303;-2267.422,2168.492;Float;False;Global;fKr4PI;fKr4PI;16;1;[HideInInspector];Create;True;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;304;-2266.422,2237.492;Float;False;Global;fKm4PI;fKm4PI;16;1;[HideInInspector];Create;True;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;301;-952.566,2241.185;Float;False;Global;fKrESun;fKrESun;16;1;[HideInInspector];Create;True;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;76;-2402.91,-197.2692;Half;False;Property;_AtmosphereFalloff;Atmosphere Falloff;14;0;Create;True;0;0.66;1;0.1;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;302;-792.5661,2305.185;Float;False;Global;fKmESun;fKmESun;16;1;[HideInInspector];Create;True;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;444;-776.5661,2209.185;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;137;-2182.301,-443.3563;Half;False;Property;_AtmosphereFar;Atmosphere Far;12;0;Create;True;0;0.359,0.7974198,1,1;0.359,0.7974198,1,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;136;-2180.101,-606.8557;Half;False;Property;_AtmosphereNear;Atmosphere Near;13;0;Create;True;0;1,0.3724138,0,1;0.7426471,0.5287186,0.4017721,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;445;-648.5661,2209.185;Float;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;162;-1173.189,-1032.713;Half;False;Property;_NightLightsIntensity;Night Lights Intensity;16;0;Create;True;0;1;0.357;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;483;-1323.59,-2022.577;Half;False;Property;_EnableFauxAtmosphere;Enable Faux Atmosphere;11;0;Create;True;0;1;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-2424.119,-1073.946;Half;False;Property;_NormalScale;Normal Scale;10;0;Create;True;0;1;1;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;63;-2135.486,-1119.75;Float;True;Property;_NormalMap;NormalMap;9;1;[NoScaleOffset];Create;True;0;None;832b069de320ff245b2d3e16fc2e97b4;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;265;-168.0777,-885.1198;Float;True;Property;_SpecMap;Spec Map;8;0;Create;True;0;None;05f355c72668ac3478b983e3887d3f6e;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;183;107.0387,-301.6296;Fixed;False;Property;_NightLightBlue;Night Light Blue;20;0;Create;True;0;0.35;0.35;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;463;169.8347,-511.7579;Float;False;462;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;260;84.69568,-1045.951;Half;False;Property;_SpecularColor;Specular Color;7;0;Create;True;0;0,0,0,0;0.492681,0.5350211,0.609,1;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;501;171.4197,-91.38559;Float;False;497;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;182;105.0387,-371.6296;Fixed;False;Property;_NightLightGreen;Night Light Green;19;0;Create;True;0;0.75;0.835;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;274;107.1818,-231.3527;Float;False;Property;_NightLightsSoftness;Night Lights Softness;17;0;Create;True;0;0.3;0.1;0.1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;181;104.0387,-440.6298;Fixed;False;Property;_NightLightRed;Night Light Red;18;0;Create;True;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;569;560.7277,-637.4788;Float;False;Blinn-Phong Light JCOR;2;;182;abf9cb092ab53d741a85db181c4b9f11;0;11;43;COLOR;0,0,0,0;False;100;FLOAT3;0,0,0;False;42;COLOR;0,0,0,0;False;52;FLOAT3;0,0,0;False;77;FLOAT;0;False;70;FLOAT;0;False;74;FLOAT;0;False;76;FLOAT;0;False;113;FLOAT;0;False;115;FLOAT3;0,0,0;False;114;FLOAT;0;False;2;FLOAT3;0;FLOAT;57
...
WireConnection;569;43;260;0
WireConnection;569;100;266;0
WireConnection;569;42;461;0
WireConnection;569;52;145;0
WireConnection;569;77;463;0
WireConnection;569;70;181;0
WireConnection;569;74;182;0
WireConnection;569;76;183;0
WireConnection;569;113;274;0
WireConnection;569;115;500;0
WireConnection;569;114;501;0
WireConnection;0;13;569;0
ASEEND*/
//CHKSM=F004C31B09A09B0F8184B673954C7446CED3780D