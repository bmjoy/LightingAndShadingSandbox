...
Shader "Pipeworks_Custom/Phong ASE"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif
			float3 newWorldNormal22_g78 = WorldNormalVector( i , float3(0,0,1) );
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldlightDir = normalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			float dotResult3_g80 = dot( newWorldNormal22_g78 , ase_worldlightDir );
			float temp_output_6_0_g79 = (saturate( max( dotResult3_g80 , 0.0 ) )*0.65 + ( 1.0 - 0.65 ));
			...
			float3 temp_output_2_0_g77 = ase_worldNormal;
			float dotResult5_g77 = dot( temp_output_3_0_g77 , temp_output_2_0_g77 );
			float dotResult7_g76 = dot( ase_worldViewDir , ( ( 2.0 * saturate( max( dotResult5_g77 , 0.0 ) ) * temp_output_2_0_g77 ) - temp_output_3_0_g77 ) );
...
Node;AmplifyShaderEditor.FunctionNode;57;-544.6135,903.1041;Float;False;Lambert Wrap;-1;;78;31f8f5f80290a284a82e58e8d6bb3fef;5;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT3;0,0,0;False;2;FLOAT3;FLOAT
...
ASEEND*/
//CHKSM=167B20581D83AD3D9490743EC905829DC53B76E5