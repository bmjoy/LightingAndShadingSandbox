...
Shader "Pipeworks_Custom/Terrain 16K ASE"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			fixed DISP_MAP511 = (( LSD_UV442.x >= 0.5 ) ? (( LSD_UV442.y <= 0.5 ) ? ( half4( LSD3465 , 0.0 ) + BLACK8_g143 ) :  ( half4( LSD1463 , 0.0 ) + BLACK8_g143 ) ) :  (( LSD_UV442.y <= 0.5 ) ? ( half4( LSD2464 , 0.0 ) + BLACK8_g143 ) :  ( half4( LSD0462 , 0.0 ) + BLACK8_g143 ) ) ).z;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			fixed SPEC_MAP507 = (( LSD_UV442.x >= 0.5 ) ? (( LSD_UV442.y <= 0.5 ) ? ( half4( LSD3465 , 0.0 ) + BLACK8_g143 ) :  ( half4( LSD1463 , 0.0 ) + BLACK8_g143 ) ) :  (( LSD_UV442.y <= 0.5 ) ? ( half4( LSD2464 , 0.0 ) + BLACK8_g143 ) :  ( half4( LSD0462 , 0.0 ) + BLACK8_g143 ) ) ).y;
			...
			fixed COMPOSITE_NIGHTLIGHTS435 = (( LSD_UV442.x >= 0.5 ) ? (( LSD_UV442.y <= 0.5 ) ? ( half4( LSD3465 , 0.0 ) + BLACK8_g143 ) :  ( half4( LSD1463 , 0.0 ) + BLACK8_g143 ) ) :  (( LSD_UV442.y <= 0.5 ) ? ( half4( LSD2464 , 0.0 ) + BLACK8_g143 ) :  ( half4( LSD0462 , 0.0 ) + BLACK8_g143 ) ) ).x;
...
/*ASEBEGIN
Version=14304
1998;29;1796;1125;895.7188;4059.83;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;146;-283.2031,-2344.51;Float;False;1832.302;729.9859;Faux Ground Scatter Effect;13;142;153;141;138;140;105;139;136;137;90;89;76;251;Atmosphere;0.03448296,1,0,1;0;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;509;294.6605,-2819.628;Float;False;FLOAT4;1;0;FLOAT4;0.0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
Node;AmplifyShaderEditor.RangedFloatNode;162;1743.839,-3703.73;Half;False;Property;_NightLightsIntensity;Night Lights Intensity;25;0;Create;True;1;0.8;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;89;-178.9187,-1901.717;Float;False;65;0;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;284;25.84977,-4750.626;Float;False;3;3;0;FLOAT;0,0,0;False;1;FLOAT;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=1BF6F98758337A5A18AD6F93BC9DE7BED0A62627